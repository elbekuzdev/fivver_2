...
public class HiringMapper {
    ...
    public static ResponseHiringDto toDto(Hiring hiring){
        return new ResponseHiringDto(hiring.getId(), hiring.getTitle(), hiring.getDescription(), hiring.getState(), hiring.getUser(), hiring.getStartPrice(), hiring.getPrice(), HashtagsMapper.toDto(hiring.getTags()), hiring.getCreationTime());
    }
